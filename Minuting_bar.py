...
print('Novel summary words in ELITR_Minuting_corpus: ',novel_summ_word(df,'automin'))
...
print('Position of big sentences in ICSI vs ELITR_Minuting_corpus: ')
print(ttest_ind(df.position_big.icsi_transcripts,df.position_big.automin_transcripts))
print('Position of big sentences in AMI vs ELITR_Minuting_corpus: ')
...
print('Perplexity AMI: ', sum(perplexity)/len(perplexity))
print('Entropy AMI: ', np.log2(sum(perplexity)/len(perplexity)))
...
print('Perplexity ICSI: ', sum(perplexity)/len(perplexity))
print('Entropy ICSI: ', np.log2(sum(perplexity)/len(perplexity)))
...
print('Perplexity ELITR_Minuting_corpus: ', sum(perplexity)/len(perplexity))
print('Entropy ELITR_Minuting_corpus: ', np.log2(sum(perplexity)/len(perplexity)))
...
print('ELITR_Minuting_corpus:', correlation('automin'))
...
print('Jaccard similarity between transcript and summary topics AMI: ', statistics.mean(similarity))
...
for index in range(len(text_list)):
    ...
    for topic in topics:
        for index in range(1,len(topic[1].split('"')),2):
            s_topic.append(topic[1].split('"')[index])
    similarity.append(get_jaccard_sim(t_topic, s_topic))
print('Jaccard similarity between transcript and summary topics ICSI: ', statistics.mean(similarity))
...
for key in automin_transcripts.keys():
    ...
    for topic in topics:
        for index in range(1,len(topic[1].split('"')),2):
            s_topic.append(topic[1].split('"')[index])
    similarity.append(get_jaccard_sim(t_topic, s_topic))
print('Jaccard similarity between transcript and summary topics ELITR_Minuting_corpus: ', statistics.mean(similarity))
...
ax.figure.savefig('Total Sentences.png')

"""### Total words """

ax=sns.barplot(x=df.label,y=df.total_words, hue=df.dataset, palette='Blues')
ax.set(xlabel='Datasets', ylabel='Total words')
ax.figure.savefig('Total words.png')

"""### Total refined words  (occurance)"""

ax = sns.barplot(x=df.label,y=df.total_refined_words, hue=df.dataset, palette='Blues')
ax.figure.savefig('Total refined words.png')
...
ax.figure.savefig('Total unique refined words.png')
...
ax.figure.savefig('Frquency of small talk.png')
...
ax.figure.savefig('Frquency of big talk.png')
...
ax.figure.savefig('% of small sents.png')
...
ax.figure.savefig('% of continous small sents.png')

ax = sns.barplot(x=df.label,y=(df.count_big/df.total_sent)*100, hue=df.dataset, palette='Blues')
ax.figure.savefig('% of continous big sents.png')
...
ax.figure.savefig('Average length of sents.png')
...
ax.figure.savefig('Average length per words.png')
...
ax.figure.savefig('Max sentence length.png')
...
ax.figure.savefig('Max sentence Position.png')
...
ax.figure.savefig('no of topics per doc.png')
...
print('AMI Occurence of important sents mean: ',statistics.mean(important))
...
for key in range(len(text_list)):
    ...
    important.append(len(scores))
print('ICSI Occurence of important sents mean: ',statistics.mean(important))
...
for key in automin_transcripts.keys():
    ...
    important.append(len(scores))
print('ELITR_Minuting_corpus Occurence of important sents mean: ',statistics.mean(important))
...
ax.figure.savefig('Imp sents per doc.png')